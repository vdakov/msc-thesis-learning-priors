...
class TransformerModel(nn.Module):
    ...
    def forward(self, src, src_mask=None, single_eval_pos=None):
        ...
        :param src: the input data - possibly a tuple, if we are fusing them
        :param src_mask: ?
        :param single_eval_pos: permutation invariant setup. If a single evaluatio position. This is a number that separates the context set and the 
        evaluation set.
        '''
        ...
        if not fuse_x_y:
            #this means they are not fused already
            x_src, y_src = src
